...
- `[~]` **`exportMyData` returns the author's own `recipes`/`drafts` as full Mongo docs** *(claimed 2026-07-08, `worktree-feat+export-own-recipes-projection`)* — same leak class
