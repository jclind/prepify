...
| **Accessibility** | 2026-06-25 | #179 (+#181, #184 contrast follow-ups) | ingredient-checklist role (recipe page 89→97); grey / teal / beta-tag / error-red contrast | 5 (1 resolved) → [BACKLOG → Accessibility](../BACKLOG.md#accessibility): autocomplete listbox + keyboard nav, servings target-size, `$primary-hover` AA-on-hover, brand orange (reverted to vivid — owner call), ~~account-heading route-map~~ (done — PR #200) |
