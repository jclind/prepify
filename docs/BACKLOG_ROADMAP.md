...
| **8** | **X2 · `RecipeCardType` typing cleanup** | tighten the card-shape typing across `src/types.ts` + `src/api/recipes.ts` (BACKLOG Tech debt) | `[~]` `feat/x2-recipecard-typing` (2026-07-09) | `src/types.ts`, `src/api/recipes.ts` | ready — §D file ownership released |
