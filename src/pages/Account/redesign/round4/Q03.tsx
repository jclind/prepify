...
// Q3 — Icon trio. The quietest: Edit, Settings and Share are all small circular
// icon buttons, and the XP bar carries a tiny trophy icon for rewards. Minimal
// ink, maximum calm.
const Q03: FC = () => {
      ...
      <div className='r3soft-wrap'>
        <header className='r3soft-head'>
          ...
          <div className='r4-xprow'>
            <XpBar />
            <RewardsButton flavour='icon' />
          </div>
          <div className='r4-actions'>
            <EditButton onClick={() => edit.setOpen(true)} iconOnly />
            <SettingsButton />
            <ShareButton />
          </div>
        </header>
